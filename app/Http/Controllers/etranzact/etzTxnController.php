...
class etzTxnController extends Controller
{
    ...
    public function getToken(){
       ...
       // return ("eyJhbGciOiJIUzUxMiJ9.eyJpZCI6IjEwMDAwMDA4NzEiLCJleHAiOjE3MTQ4NjE5NDUsImlhdCI6MTcxNDgxMTk0NX0.EGg405ZNaOyDCzCBIt2BOZkBY_vb2MFKfcpQG5BfWR3FNh1FQmZNuiNrYxmvwAa6pP_YJkEUFB9SjrWj_H9NHQ");
    ...
    Public function salaryInfo(Request $request){
        ...
        //     return $response; // salary information to .net
            
        // }
        // else{
        //     return $response; //error message to .net
        // }
    }
...
public function createLoan(Request $request){
    ...
    $payload = [
        ...
        'rentalAmount' => (double) $request->rentalAmount,
